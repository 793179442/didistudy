...
CREATE TABLE `by_news_info` (
  ...
  PRIMARY KEY (`news_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='消息中心';
...
INSERT INTO `by_news_info` VALUES (1,11111111,'11111111464646','13213131113131313',1),(2,NULL,'ewfwefe','fewfew',2),(3,1294943788,'111','111',1);
