...
CREATE TABLE `by_course_type` (
  ...
  `type_name` varchar(32) DEFAULT NULL COMMENT '类名',
  `parent_id` int(11) DEFAULT NULL COMMENT '父类 0 顶级分类',
...
INSERT INTO `by_course_type` VALUES (1,'11',0,NULL),(2,'rw3rrw',0,NULL),(3,'11',2,NULL),(4,'few',0,0),(5,'fef',0,0),(6,'fewe',1,NULL),(7,'fefe',6,1);
