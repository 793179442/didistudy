...
INSERT INTO `by_admin_info` VALUES (1,'admin','e10adc3949ba59abbe56e057f20f883e',1,1487922045,1487928621),(2,'test','e10adc3949ba59abbe56e057f20f883e',2,1487922131,1487922131);
...
INSERT INTO `by_course` VALUES (11,'22',2,NULL,2,'','2',22,'2','2','2',2,2,'','2',2,0,'2',NULL);
...
CREATE TABLE `by_function_module` (
  ...
  PRIMARY KEY (`fm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='功能模块表';

#
# Data for table "by_function_module"
#

INSERT INTO `by_function_module` VALUES (1,'管理员信息管理',0,NULL,NULL,1,0),(2,'查看',1,'Admin','index',1,0),(3,'添加',1,'Admin','addAdmin',1,0),(4,'修改',1,'Admin','editAdmin',1,0),(5,'删除',1,'Admin','delAdmin',1,0),(6,'角色信息管理',0,NULL,NULL,1,0),(7,'查看',6,'Role','index',1,0),(8,'添加',6,'Role','addRole',1,0),(9,'修改',6,'Role','editRole',1,0),(10,'删除',6,'Role','delRole',1,0),(11,'公共参数设置',0,NULL,NULL,1,0),(12,'查看',11,'CommonParameter','index',1,0),(13,'添加',11,'CommonParameter','addCommonParameter',1,0),(14,'修改',11,'CommonParameter','editCommonParameter',1,0),(15,'删除',11,'CommonParameter','ajaxDelCommonParameter',1,0),(16,'机构信息设置',0,NULL,NULL,1,0),(17,'查看',16,'Instituition','index',1,0),(18,'添加',16,'Instituition','addInstituition',1,0),(19,'修改',16,'Instituition','editInstituition',1,0),(20,'删除',16,'Instituition','ajaxDelInstituition',1,0),(21,'小区信息设置',0,NULL,NULL,1,0),(22,'查看',21,'ResidentialQuarters','index',1,0),(23,'添加',21,'ResidentialQuarters','addResidentialQuarters',1,0),(24,'修改',21,'ResidentialQuarters','editResidentialQuarters',1,0),(25,'删除',21,'ResidentialQuarters','ajaxDelResidentialQuarters',1,0),(26,'课程信息设置',0,NULL,NULL,1,0),(27,'查看',26,'Course','index',1,0),(28,'添加',26,'Course','addCourse',1,0),(29,'修改',26,'Course','editCourse',1,0),(30,'删除',26,'Course','ajaxDelCourse',1,0),(31,'学生信息设置',0,NULL,NULL,1,0),(32,'查看',31,'Student','index',1,0),(33,'添加',31,'Student','addStudent',1,0),(34,'修改',31,'Student','editStudent',1,0),(35,'删除',31,'Student','ajaxDelStudent',1,0),(36,'老师信息设置',0,NULL,NULL,1,0),(37,'查看',36,'Teacher','index',1,0),(38,'添加',36,'Teacher','addTeacher',1,0),(39,'修改',36,'Teacher','editTeacher',1,0),(40,'删除',36,'Teacher','ajaxDelTeacher',1,0),(41,'2',0,NULL,NULL,1,0),(42,'添加',41,'Parking','addParking',1,0),(43,'查看',41,'Parking','index',1,0),(44,'修改',41,'Parking','editParking',1,0),(45,'删除',41,'Parking','ajaxDelParking',1,0),(46,'1',0,NULL,NULL,1,0),(47,'查看',46,'ParkingLot','index',1,0),(48,'删除',46,'ParkingLot','ajaxDelParkingLot',1,0),(49,'修改',46,'ParkingLot','editParkingLot',1,0),(50,'添加',46,'ParkingLot','addParkingLot',1,0),(51,'3',0,NULL,NULL,1,0),(52,'查看',51,'ChargingItem ','index',1,0),(53,'添加',51,'ChargingItem ','addChargingItem ',1,0),(54,'修改',51,'ChargingItem ','editChargingItem ',1,0),(55,'删除',51,'ChargingItem ','ajaxDelChargingItem ',1,0),(56,'收费标准设置',0,NULL,NULL,1,0),(57,'查看',56,'ChargeStandard','index',1,0),(58,'添加',56,'ChargeStandard','addChargeStandard',1,0),(59,'修改',56,'ChargeStandard','editChargeStandard',1,0),(60,'删除',56,'ChargeStandard','ajaxDelChargeStandard',1,0),(61,'首页公告设置',0,NULL,NULL,1,0),(62,'查看',61,'News','index',1,0),(64,'修改',61,'News','editNews',1,0),(65,'首页轮播图设置',0,NULL,NULL,1,0),(66,'查看',65,'ImgShow','index',1,0),(67,'添加',65,'ImgShow','addimg',1,0),(68,'删除',65,'ImgShow','ajaxDelImg',1,0),(69,'首页栏目设置',0,NULL,NULL,1,0),(70,'查看',69,'IndexMenu','index',1,0),(71,'添加',69,'IndexMenu','addMenu',1,0),(72,'修改',69,'IndexMenu','editMenu',1,0),(73,'删除',69,'IndexMenu','ajaxDelMenu',1,0);
...
INSERT INTO `by_menu_info` VALUES (1,'权限设置',0,NULL,NULL,'ec-users',1,0),(2,'管理员信息管理',1,'Admin','index','ec-user',1,0),(3,'角色信息',1,'Role','index','br-eye',1,0),(4,'公共参数设置',0,'CommonParameter','index','ec-cog',1,0),(5,'机构信息设置',0,'Instituition','index','im-home3',1,0),(6,'消息管理',0,'ResidentialQuarters','index','im-office',1,0),(7,'课程信息设置',0,'Course','index','im-home',1,0),(8,'学生信息设置',0,'Student','index','im-home2',1,0),(9,'教师信息设置',0,'Teacher','index','im-user4',1,0),(10,'订单中心',0,NULL,NULL,'im-paragraph-justify',1,0),(11,'需求信息',10,'Parking','index','im-table',1,0),(12,'订单管理',10,'ParkingLot','index','im-table2',1,0),(13,'收费设置',0,NULL,NULL,'im-cogs',1,0),(14,'收费项目设置',13,'ChargingItem ','index','im-cog',1,0),(15,'收费标准设置',13,'ChargeStandard','index','im-cog2',1,0),(16,'首页设置',0,NULL,NULL,'im-paragraph-justify',1,0),(17,'公告设置',16,'News','index','im-table',1,0),(18,'轮播图设置',16,'ImgShow','index','im-cog',1,0),(19,'栏目设置',16,'IndexMenu','index','im-table',1,0);
...
INSERT INTO `by_role_info` VALUES (1,'超级管理员','2,3,4,5,66,67,68,62,64,47,48,49,50,42,43,44,45,37,38,39,40,32,33,34,35,27,28,29,30,22,23,24,25,17,18,19,20,12,13,14,15,7,8,9,10,70,71,72,73','所有权限'),(2,'测试','2,3,4,5','……………………');
...
INSERT INTO `by_teacher` VALUES (3,'1123112321321',1,'XX',0,'efewf','fewf','wfew','fewfe','fefef','ewfewfwefew',1,NULL,NULL),(4,'11',0,NULL,1,'11','','1','11','11','11',1,NULL,NULL),(5,'11',0,NULL,1,'11','','11','11','11','11',1,NULL,NULL),(6,'11',0,NULL,1,'1','','11','11','11','11',1,NULL,NULL),(7,'11',0,NULL,1,'1','','11','1','1','11',1,NULL,NULL);
