                            ...
                            <div class="collapse navbar-collapse">
                                <form class="navbar-form form-inline" action="" method="get">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="input-mobile">课程姓名：</label>
                                        <div class="form-group">
                                            <input type="text" name="p_Course_name" value='<?php echo ($_GET['p_Course_name']); ?>' class="form-control" placeholder="课程姓名" />
                                        </div>
                                    </div>
                                    <div class="form-group">
<!--                                         <label class="control-label" for="input-mobile">所属小区：</label>
                                    ...
                                    <div class="form-group pull-right"> 
                                        ...
                                        <a href="<?php echo U('Admin/Course/addCourse');?>" class="btn btn-primary">添加课程信息</a>
                                        <a href="javascript:void(0)" class="btn btn-danger pull-right del_cus del_all" style="margin-left: 2px;" data-url="<?php echo U('Admin/Course/ajaxDelCourse');?>"><i class="fa fa-trash-o"></i> 删除</a>
                                    </div>
                                </form>
                            </div>
                        </nav>
                        <div class="table-responsive">
                            <table  class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php if(empty($Course_list)): ?><tr role="row" align="center"><td colspan="6">暂无数据</td></tr>
                                    <?php else: ?>
                                    <?php if(is_array($Course_list)): $i = 0; $__LIST__ = $Course_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$customer): $mod = ($i % 2 );++$i;?><tr role="row">
                                           ...
                                           <!--  <td><?php echo ($customer["residential_quarters_name"]); ?></td> -->
                                            <td><?php echo ($customer["course_price"]); ?></td>
                                            <td><?php echo ($customer["person_range"]); ?></td>
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="<?php echo U('Admin/Course/detailInfo',array('course_id'=>$customer['course_id']));?>">查看</a>
                                                <a class="btn btn-primary btn-sm" href="<?php echo U('Admin/Course/editCourse',array('course_id'=>$customer['course_id']));?>">编辑</a>
                                                <a class="btn btn-danger btn-sm del_cus" href="javascript:void(0)" data-url="<?php echo U('Admin/Course/ajaxDelCourse');?>" data-id="<?php echo ($customer["course_id"]); ?>">删除</a>
                                            </td>
