...
<div class = "container student-1">
    ...
    <header class="header c1">
        <a href="javascript:void(0);" onclick="leftcolumn1();"><span  class="top-icon-menu"></span></a>
    </header>
    ...
    <div class = "page">
        ...
        <div class="bar1">
            <input type="text" name=""  class="white-style input-class1 sssss" placeholder="输入你要学什么">
        </div>
...
$(function(){
    $('.sssss').click(function(){
        ...
        function leftcolumn1(){
            var time=1;
                 $.ajax({
                    url:"<?php echo U('Wap/Student/checklogin');?>",
                    async: true,
                    type: 'post',
                    data: {time:time},
                    dataType: 'json',
