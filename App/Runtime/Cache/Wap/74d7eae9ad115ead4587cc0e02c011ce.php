    ...
    <div class = "page">
        ...
        <div>   
                ...
                <div class="bar2">
                    ...
                    <div><input type="password" name="" placeholder="请输入登录密码" class="t2 pwd"></div>
                </div>
                <div class="bar3">
                    <button type="">登录</button>
                </div>
                <div class="bar4">
                    <a href="<?php echo U('Wap/Index/registered');?>">立即注册</a> | 
                    <a href="#">忘记密码?</a>
                </div>
                <div class="bar5">
                    <img src="__WAP__/images/san.png">
                    <div>
                        <a href="#"><img src="__WAP__/images/san1.png"></a>
                        <a href="#"><img src="__WAP__/images/san2.png"></a>
                        <a href="#"><img src="__WAP__/images/san3.png"></a>
                    </div>
                </div>
...
$(".bar3").click(function(){
            ...
            var pwd=$(".pwd").val();
                 $.ajax({
                    url:"<?php echo U('Wap/Index/ajaxloginf');?>",
                    async: true,
                    type: 'post',
