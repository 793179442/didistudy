...
<div class = "container bill">
    ...
    <div class = "page">  
        <div class="bar1">
            <p>已付款，如未预约服务时间请提前联系</p>
            <img src="__WAP__/images/order/o2.png">
        </div>
    </div>
    <div class="bar2">
        <div class="t1">
        ...
        <div class="t2">
            <div>
                <span class="left">初中数学辅导补习16课</span>
    ...
    <div class="bar3">
        ...
        <div> 
            <label>服务地址</label> 
            <span>汕头市龙湖区锦华昌大厦</span>
        </div>
        <div> 
            <label>下单时间</label> 
            <span>2017-05-05 17:55</span>
        </div>
        <div> 
            <label>订单号</label> 
            <span>17052517093151150301449462</span>
        </div>
    </div>
</div>
</body>
