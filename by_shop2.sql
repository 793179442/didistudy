...
INSERT INTO `by_menu_info` VALUES (1,'权限设置',0,NULL,NULL,'ec-users',1,0),(2,'管理员信息管理',1,'Admin','index','ec-user',1,0),(3,'角色信息',1,'Role','index','br-eye',1,0),(4,'公共参数设置',0,'CommonParameter','index','ec-cog',1,0),(5,'机构信息设置',0,'Instituition','index','im-home3',1,0),(6,'小区信息设置',0,'ResidentialQuarters','index','im-office',1,0),(7,'课程信息设置',0,'Course','index','im-home',1,0),(8,'学生信息设置',0,'Student','index','im-home2',1,0),(9,'教师信息设置',0,'Teacher','index','im-user4',1,0),(10,'停车场设置',0,NULL,NULL,'im-paragraph-justify',1,0),(11,'停车场信息设置',10,'Parking','index','im-table',1,0),(12,'车位信息设置',10,'ParkingLot','index','im-table2',1,0),(13,'收费设置',0,NULL,NULL,'im-cogs',1,0),(14,'收费项目设置',13,'ChargingItem ','index','im-cog',1,0),(15,'收费标准设置',13,'ChargeStandard','index','im-cog2',1,0),(16,'首页设置',0,NULL,NULL,'im-paragraph-justify',1,0),(17,'公告设置',16,'News','index','im-table',1,0),(18,'轮播图设置',16,'ImgShow','index','im-cog',1,0),(19,'栏目设置',16,'IndexMenu','index','im-table',1,0);
